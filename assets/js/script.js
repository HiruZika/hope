...
const questions = [
  {
    question: "Apa bahasa Palembang dari kecewa?",
    answers: {
      a: "Sakit Hati",
      b: "Cugak",
      c: "Kecewah"
  ...
  {
    question: "Apa bahasa Ogan dari Paman?",
    answers: {
      a: "Pakng",
      b: "Oom",
      c: "Mangcek"
  ...
  {
    question: "Manakah yang bukan termasuk bahasa daerah di Sumatera Selatan?",
    answers: {
      a: "Palembang",
      b: "Sunda",
      c: "Kombering"
  ...
  {
    question: "Dimanakah asal dari makanan pempek?",
    answers: {
      a: "Betawi",
      b: "Pali",
      c: "Palembang"
  ...
  {
    question: "Manakah diantara bahasa daerah Palembang dan Lematang yang merupakan bahasa daerah?",
    answers: {
      a: "Palembang",
      b: "Semua Benar",
      c: "Lematang"
...
function displayQuestion() {
  ...
  document.getElementById('answerA').textContent = currentQuestionData.answers.a;
  document.getElementById('answerB').textContent = currentQuestionData.answers.b;
  document.getElementById('answerC').textContent = currentQuestionData.answers.c;
}
